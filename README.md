...
Distributing Encryption Keys with QuTech hardware and an interface server, to allow poeple to communicate securely. This allow people all over the world to send anyone anything no matter how sensible or controversial the information might be.
